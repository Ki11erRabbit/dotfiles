...
keys = [
    ...
    Key([mod], "m", lazy.layout.left(), desc="Move focus to left"),
    ...
    Key([mod, "shift"], "m", lazy.layout.shuffle_left(), desc="Move window to the left"),
    ...
    Key([mod, "control"], "m", lazy.layout.grow_left(), desc="Grow window to the left"),
